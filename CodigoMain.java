...
public class CodigoMain {
        ...
        while (continuar) {
            String op = (String) JOptionPane.showInputDialog(
                null, "Hola. Elija una Alternativa", "Menu", JOptionPane.DEFAULT_OPTION, null, opciones, opciones[0]
            );
    ...
    public static void Moneda() {
    	 String monto = JOptionPane.showInputDialog(null, "Ingrese Cantidad que desea convertir");
    	 double montoIngresado = 0.0;
    	 String resultadoFormateado;
    	 Moneda moneda = new Moneda();
    	 
         if (monto == null || monto.isEmpty()) {
             JOptionPane.showMessageDialog(null, "No se ingresó un cantidad valida.", "Error", JOptionPane.ERROR_MESSAGE);
             System.exit(0);
         }
